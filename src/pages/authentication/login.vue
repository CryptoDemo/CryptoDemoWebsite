    ...
    <v-container class="form-layout overflow-hidden" :class="isDark ? 'form-layout':'form-layout-light'">
      <v-row no-gutters>
        <v-col dense cols="md-5" class="form" :class="isDark ? 'form':'form-light'" style="padding: 0px 70px;">
          <div>
            <div style="margin-top: 110px;"><span class="card-title" :class="isDark ? 'card-title':'card-title-light'">Login to Demo</span></div>

            <v-alert  v-model="alert" variant="text" :class="isDark ? 'alert-box':'alert-box-light'"  style="border-radius: 25px; width: 298.116px; height: 64px; color: #E33E38;font-family: Manrope; font-size: 11px; font-style: normal; font-weight: 400; line-height: 150%; position: absolute; margin-top: 25px;">
              <div style="display: flex;">
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 16 16" fill="none" class="me-3">
                ...
                <span>The phone number or password you entered is incorrect. Note that the password field is case-sensitive.</span>
            </div>
            </v-alert>
