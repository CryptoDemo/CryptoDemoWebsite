      ...
      <v-row no-gutters>
        <v-col dense cols="md-5" class="form" :class="isDark ? 'form':'form-light'" style="padding: 0px 70px;">
          <div>
            ...
            <v-alert  v-model="alert" variant="plain" :class="isDark ? 'alert-box':'alert-box-light'"  style="border-radius: 25px; width: 298.116px; height: 64px; color: #E33E38;font-family: Manrope; font-size: 11px; font-style: normal; font-weight: 400; line-height: 150%; position: absolute; margin-top: 25px;">
