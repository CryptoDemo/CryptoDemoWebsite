    ...
    <v-row no-gutters  class="">
      ...
      <v-col dense cols="md-5" class="form" style="padding: 0px 70px;">
        <div class="" style="margin-top:55.88px; margin-bottom:55.88px;">
          ...
          <span class="card-title">Login to Demo</span>

          <v-alert  v-model="alert"  variant="tonal" style="border-radius: 25px; background: #161D26 !important; width: 298.116px; height: 64px; color: #E33E38;font-family: Manrope; font-size: 12px; font-style: normal; font-weight: 400; line-height: 150%; position: absolute; margin-top: 25px;">
            <div style="display: flex;">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" class="me-3">
                <path d="M7.99992 14.6666C11.6666 14.6666 14.6666 11.6666 14.6666 7.99992C14.6666 4.33325 11.6666 1.33325 7.99992 1.33325C4.33325 1.33325 1.33325 4.33325 1.33325 7.99992C1.33325 11.6666 4.33325 14.6666 7.99992 14.6666Z" stroke="#E33E38" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M8 5.33325V8.66659" stroke="#E33E38" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M7.99634 10.6667H8.00233" stroke="#E33E38" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
              <span>Verification code has been sent to the registered email.</span>
          </div>
          </v-alert>
           <div class="position-relative" style="margin-top: 139px">
              <!-- <div class="position-relative"> -->
            <v-text-field placeholder="Email Address" class="input-styling" v-model.trim="email"
                variant="text">
          ...
          <div class="position-relative">
            ...
            <NuxtLink to="/authentication/reset-password"><span class="resend-code d-flex" style="margin-top:21px; justify-content: end;">Forgot Password?</span></NuxtLink>
             <Button :disabled="!isFormValid" @click.prevent="isFormValid ? login() : null" buttonText="Continue" class="" style="margin-top: 48px; margin-bottom:206px"/>
...
const login =  () => {
  if (email.value === 'correct@email.com' && password.value === 'correctpassword') {
    // Correct credentials
    alert.value = false;
    // Proceed with login
  } else {
