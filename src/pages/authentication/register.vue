<template>
  <div>
    ...
    <Header @country="v => country = v" text2="Already have an account," title="Login" link="/authentication/login" :flagDropdown="true"/> 
          ...
          <v-col dense cols="md-5" class="form" :class="isDark ? 'form':'form-light'" style="padding: 0px 70px;">
            ...
            <span class="card-title" :class="isDark ? 'card-title':'card-title-light'">Create Your Account</span>
              ...
              <div class="position-relative">
                <v-text-field placeholder="Full Name" class="pr-14" variant="plain" :rules="username" :class="isDark ? 'input-styling':'input-styling-light'" v-model="name" style="font-size: 12px !important; margin-bottom: 21px;">
