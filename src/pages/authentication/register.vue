        ...
        <v-col dense cols="md-5" class="form" :class="isDark ? 'form':'form-light'" style="padding: 0px 70px;">
          ...
          <span class="card-title" :class="isDark ? 'card-title':'card-title-light'">Create Your Account</span>
            <div class="card-subtitle" :class="isDark ? 'card-subtitle':'card-subtitle-light'">Setting up an account takes less than 1 minute.</div>
              ...
              <v-text-field placeholder="Email Address" class="input-styling" :class="isDark ? 'input-styling':'input-styling-light'"  v-model="email" :rules="Emailrules" style="font-size: 12px !important;"
                  variant="text">
              ...
              <div class="position-relative">
                <v-text-field class="input-styling" :class="isDark ? 'input-styling':'input-styling-light'" style="margin-top:20.81px;" :type="isToggled ? 'text' : 'password'" v-model="password" :rules="Passwordrules"
              ...
              <v-text-field placeholder="Referral code (Optional)" class="input-styling" :class="isDark ? 'input-styling':'input-styling-light'" style="margin-top:20.81px;"
                  variant="">
                  <v-icon class="prepend-inner-icon">
...
<style scoped>
/* .btn-outlined{
width: 300.384px!important;
height: 57.474px!important;
flex-shrink: 0;
border-radius: 24px;
border: 1px solid var(--Primary-80, #5892FF)!important;
background: #161D26;
