<template>
  <div class="section">
    ...
    <Header @country="v => country = v" text2="Already have an account," title="Login" link="/authentication/login" :newUserLanguage="true" :flagDropdown="true"/> 
      <v-container  class="form-layout overflow-hidden" :class="isDark ? 'form-layout':'form-layout-light'" style="overflow-y: scroll !important;">
        <div class="section">
        <v-row no-gutters>
          <v-col dense cols="md-5" class="form" :class="isDark ? 'form':'form-light'" style="padding: 0px 70px;">
            ...
            <span class="card-title" :class="isDark ? 'card-title':'card-title-light'">Create Your Account</span>
              ...
              <div class="position-relative">
                <v-text-field placeholder="First Name" class="pr-14" variant="plain" :rules="username" :class="isDark ? 'input-styling':'input-styling-light'" v-model="Firstname" style="font-size: 12px !important; margin-bottom: 21px;">
                <v-icon class="prepend-inner-icon ml-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#b1b1b1" class="bi bi-person" viewBox="0 0 16 16">
                ...
                <v-text-field placeholder="Last Name" class="pr-14" variant="plain" :rules="username" :class="isDark ? 'input-styling':'input-styling-light'" v-model="Lastname" style="font-size: 12px !important; margin-bottom: 21px;">
                <v-icon class="prepend-inner-icon ml-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#b1b1b1" class="bi bi-person" viewBox="0 0 16 16">
                    <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
                  </svg>
                ...
                <v-text-field placeholder="Email Address" class="pr-14" variant="plain" :class="isDark ? 'input-styling':'input-styling-light'" v-model="email" :rules="emailrules" style="font-size: 12px !important;">
                  <v-icon class="prepend-inner-icon ml-3">
                ...
                <div class="position-absolute tick-icon">
                 ...
                 <div class="position-relative">
                  <v-text-field class="input-styling pr-14" :class="isDark ? 'input-styling':'input-styling-light'" style="margin-top:20.81px;" :type="isToggled ? 'text' : 'password'" v-model.trim="password" :rules="passwordrules" placeholder="Password" variant="plain">
                    <v-icon class="prepend-inner-icon ml-3">
