    ...
    <v-row no-gutters  class="">
      ...
      <v-col dense cols="md-5" class="form" style="padding: 0px 70px;">
        ...
        <span class="card-title">Reset Your Password</span>
          <div class="password-subtitle" >Enter your email address or phone number to reset your password.</div>
       ...
       <div class="position-relative" v-if="isEmailPopupOpen" style="margin-bottom: 43.13px">
      ...
      <NuxtLink to="/authentication/reset-password-otp">  
      <Button buttonText="Request New Password"/>
      </NuxtLink>
