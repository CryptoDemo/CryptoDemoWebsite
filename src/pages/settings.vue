                          ...
                          <div class="pa-2 ma-2" style="margin-top: 0px!important;">
                            <div style="display: grid; width: 100%;">
                              <input type="text" v-if="phoneVerificationStep==1 || phoneVerificationStep==3" class="input-styling1 position-relative" :class="isDark ? 'profile-cards-dark':'profile-cards-light'" placeholder="002-002-003" style="outline: none; padding-left: 140px; font-size: 14px; font-weight: 400;"/>
                                ...
                                <input type="text" :class="isDark ? 'profile-cards-dark':'profile-cards-light'" v-if="phoneVerificationStep==2" style="font-size: 14px; font-weight: 400; outline: none; padding: 25px;" placeholder="6-4-0-1" class="input-styling1 position-relative"/>
                              <div>
                                <span class="number-caption" :class="isDark ? 'text-dark':'text-light'" v-if="phoneVerificationStep==1">Please set your phone number with country code. <span style="font-weight: 700;">Must be a mobile number!</span></span>
                                <span class="number-caption" :class="isDark ? 'text-dark':'text-light'" v-if="phoneVerificationStep==2">Input the code sent to your number</span>
                              </div>
                            </div> 
