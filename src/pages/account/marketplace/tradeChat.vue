    ...
    <v-container class="d-flex">
      ...
      <div class="name-div" :class="isDark ? 'Dashboard-navbar':'Dashboard-navbar-light'"> 
        ...
        <template v-slot:activator="{ props: activatorProps }">
          <span v-bind="activatorProps"  class="hidden-lg-and-up flex-sm-and-down resend-code py-4" variant="text" style="position: fixed; top: 60%; z-index: 100; letter-spacing: 0px; color: #2873FF; text-transform: capitalize; font-size: 14px; display: flex;align-items: center;">
            Trading Terms
        ...
        <template v-slot:default="{ isActive }">
          <v-card :class="isDark ? 'profile-cards-dark' : 'profile-cards-light'" style="border-radius: 10px;">
            <v-card-text>
              <span class="mb-4" style="font-weight: 600; display: flex; justify-content: center;">Risk Notice!!</span>
              <span style="font-size: 13px;"> Keep trades within Demo. Some users may ask you to trade outside the Demo platform. This is against our Terms of Services and likely a scam attempt. You must insist on keeping all trade conversations within Demo, note that we cannot help or support you if you are scammed during such trades.</span>
            </v-card-text>

            <v-card-actions>
              <v-spacer></v-spacer>

              <v-btn @click="isActive.value = false" class="primary-btn1" style="width: 100%; height: 45px; font-weight: 600; border-radius: 10px !important">I understand</v-btn>
            </v-card-actions>
          </v-card>
        </template>
        </v-dialog>
