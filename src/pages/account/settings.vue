  ...
  <div>
    ...
    <v-container style="display: flex; margin-top: 110px; margin-bottom: 113px;">
            ...
            <div style="width: 122%;">
                ...
                <v-row no-gutters class="d-sm-flex"  style="margin-top: 32px; width: 102%; margin-bottom:16px; gap: 15px">
                  <v-col  sm="6" cols="12" class="username-col">
                    <div class="d-flex username-div" style="flex-direction: column; margin-inline-end: 3px;">

                      <div class="d-flex img-col p-7" :class="isDark ? 'profile-cards-dark':'profile-cards-light'"  style="margin-top: 0px!important; margin-left: 16px; border-radius: 15px;">
                        ...
                        <div @click="$refs.imageSelector.click()">
                          ...
                          <img ref="profileImg" :src="pinia.state?.user?.profile_image || '/svg/Image-grad.svg'" class="me-4" style="align-self: start;height: 60px; width: 60px; border-radius: 50px; padding: 5px;"/>
                        </div>
                        
                        <input ref="imageSelector" @input="handleImgChange" type="file" accept="image/*" style="display:none"/>
                       
                        <div class="email-div position-relative">
                          <input type="text" placeholder="Username" v-model="username_" @input="debounce(username_)" :disabled="pinia.state.usernameChanged" class="truncate-username" style="width: 107%; height: 67px; border-radius: 15px; padding: 30px; outline: none; padding-left: 60px"/>
                          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 25 24" fill="none" style="position: absolute; bottom: 32%; left: 1%;">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="2" height="15" viewBox="0 0 2 15" fill="none" style="position: absolute; top: 41%; left: 14%;">
                      ...
                      <div class="text-div" style="width: 300px; margin-left: 23px;">
                      ...
                      <v-menu>
                          <template v-slot:activator="{ props }">
                            <v-btn class="input-styling1 ml-1" :class="isDark ? 'profile-cards-dark':'profile-cards-light'" v-bind="props"  style="box-shadow: none;">
                              <div  class="py-3" style="display: flex; cursor: pointer; position: absolute; left: 13px; align-items: center;">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" viewBox="0 0 10 6" fill="none" style="position: absolute; right: 18px; bottom: 27px;" :class="isDark ? 'svg-dark':'svg-light'">
                ...
                <div :class="isDark ? 'language-dark':'language-light'">
                  <LanguageDropdown/>
                </div>
...
const UpdateUserInfo = async () => {
  ...
  if (data.success) {
    ...
    push.success('Update Succesful');
    // Disable the username input once it's successfully updated
    pinia.state.usernameChanged = true;
...
.user-inputs :deep(.google-translate-select-dropdown__activator){
  display: flex;
  align-items: center;
  justify-content: space-between;
  padding: 1px 10px;
