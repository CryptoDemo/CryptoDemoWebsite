                  ...
                  <v-col  sm="6" cols="12" class="username-col">
                    <div class="d-flex img-col" style="margin-top: 0px!important; margin-left: 16px;">
                      ...
                      <div class="email-div position-relative">
                        <input type="text" placeholder="Username" v-model="username_" @input="debounce(username_)" :disabled="pinia.state.usernameChanged" :class="isDark ? 'profile-cards-dark':'profile-cards-light'" class="truncate-username" style="width: 107%; height: 64px; border-radius: 15px; padding: 30px; outline: none; padding-left: 60px"/>
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 25 24" fill="none" style="position: absolute; bottom: 60%; left: 4%;">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="2" height="15" viewBox="0 0 2 15" fill="none" style="position: absolute; top: 24%; left: 14%;">
