               ...
               <v-row no-gutters class="d-sm-flex"  style="margin-top: 32px; width: 100.5%; margin-bottom:16px; gap: 20px">
                    <v-col  sm="6" cols="12" class="username-col" style="margin-inline-end: px;">
                      <div class="d-flex img-col" style="margin-top: 0px!important; margin-left: 16px;">
                        ...
                        <div class="email-div">
                         <v-text-field placeholder="Username" color="success" v-model="username_" @input="debounce(username_)" class="input-styling1 pl-4 truncate-username" :class="isDark ? 'profile-cards-dark':'profile-cards-light'" variant="plain" style="text-align: justify; font-family: Poppins; font-size: 14px; font-style: normal; font-weight: 400;">
