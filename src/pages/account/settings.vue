                  ...
                  <v-col  sm="6" cols="12" class="username-col">
                    <div class="d-flex img-col" style="margin-top: 0px!important; margin-left: 16px;">
                      ...
                      <div class="email-div position-relative">
                        <input type="text" placeholder="Username" v-model="username_" @input="debounce(username_)" :class="isDark ? 'profile-cards-dark':'profile-cards-light'" class="truncate-username" style="width: 107%; height: 64px; border-radius: 15px; padding: 30px; outline: none; padding-left: 60px"/>
