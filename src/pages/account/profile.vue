                ...
                <div :class="isDark ? 'profile':'profile-light'" style="padding: 30px 15px">
                  <div class="d-flex" style="position:relative ; align-items: center; justify-content: space-between;">
                    <div class="d-flex" style="align-items: center;">
                      <img  :src="pinia.state?.user?.profile_image" width="72" class="me-3 avatar" alt="avatar"  style="display: flex; align-self: flex-start; border-radius: 55px; height: 70px;"/>
                      ...
                      <div class="unverified-div ml-3">
                        ...
                        <div v-if="pinia.state.user.kyc_verified === false">
                          ...
                          <span class="resend-code">Unverified</span>
                        </div>

                      </div>
                    </div>

                    <v-btn @click="kyc_()" class="primary-btn1" style="border-radius: 10px!important;">Verify Now</v-btn>

                    <!-- <img :src="pinia.state.user.badge"/> -->
                    ...
                    <v-col @click.prevent="navigateTo('/account/marketplace/createOffer')" sm="4" cols="12">
                      <div class="pa-4 ma-2" :class="isDark ? 'profile-cards-dark':'profile-cards-light'" style="display: flex; flex-direction: column;">
                        <div style="display: flex; align-items: flex-start; justify-content: center;">
                          ...
                          <span class="text-center resend-code mb-3 ml-1" style="font-size: 18px; font-weight: 600;">Create Offer</span>
                        </div>
