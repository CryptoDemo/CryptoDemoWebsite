  ...
  <div>
    ...
    <v-container style="display: flex; margin-top: 110px; margin-bottom: 113px;">
        <div>
            ...
            <h1 style="font-weight: 700;">Paxful, Inc. Privacy Notice</h1>

            <div  style="margin-bottom: 20px; margin-top: 15px;">

                <span>Paxful, Inc. (also referred to as “Paxful,” “we,” “us,” or “our”) takes steps to protect your privacy. In this Privacy Notice (“Notice”), we describe the types of personal information we may collect from you in connection with your use of our websites including, but not limited to, https://paxful.com/, the Paxful Wallet, our online bitcoin trading platform, mobile application, social media pages, or other online properties (collectively, the “Website”), or when you use any of the products, services, content, features, technologies, or functions we offer (collectively, the “Services”).</span>
                ...
                <span>For all purposes, the English language version of this privacy notice shall be the original, governing instrument. In the event of any conflict between the English language version of this privacy notice and any subsequent translation into any other language, the English language version shall govern and control.</span>
            </div>

            <h2 style="font-weight: 700; margin-top: 10px;">Personal information we collect</h2>

            <div class="mt-3">
                <span>We collect information that relates to you (“Personal Data”) in connection with your use of the Website, our Services. or otherwise in the context of our relationship with you. The types of Personal Data that we may obtain from you may include:</span>
            </div>
            ...
            <div class="mt-7">
               ...
               <ul class="list-bullets-styled">
                    ...
                    <span>We may also process Personal Data for other purposes based upon your consent when required by applicable law.</span>
                </ul> 
            </div>
            ...
            <div class="mt-7">
               ...
               <ul class="list-bullets-styled">
                    ...
                    <li>From social media platforms, if you interact with us through social media.</li>
                </ul>
               ...
               <ul class="list-bullets-styled">
                    ...
                    <li>Other third-parties for our business purposes or as permitted or required by law, including:
                       <ul class="list-bullets-styled">
                        ...
                        <li>To facilitate a purchase or sale of all or part of Paxful’s business. For example, by sharing data with a company we plan to merge with or be acquired by; or</li>
            ...
            <div class="mt-7">
                ...
                <span>We retain Personal Data for the period necessary for the purposes for which it was collected, or for such periods as required by applicable law. This may involve retaining Personal Data for periods following a transaction. We make efforts to delete your Personal Data once it is no longer required for any of the business purposes described above.</span>
            </div>

            <div class="mt-7">
                <h3>Data security</h3>
                <span>Paxful has implemented safeguards designed to protect your Personal Data, including measures designed to prevent Personal Data against loss, misuse, and unauthorized access and disclosure. Still, Paxful cannot ensure or warrant the security or confidentiality of information you transmit to us or receive from us by Internet or wireless connection. Transferring data through the Internet always carries some risk, even if Paxful makes efforts to protect data once it has received it.</span>
            </div>
            ...
            <div class="mt-7">
               ...
               <ul class="list-bullets-styled">
                ...
                <li>The right to withdraw any consent you have provided to Paxful to collect, use, or share your data at any time. Please note that withdrawing consent does not affect the lawfulness of Paxful processing your Personal Data before your withdrawal.</li>
                <li>The right to object to Paxful’s processing of your Personal Data, based on grounds specific to your particular situation.</li>
                <li>The right to request that Paxful restrict the processing of your Personal Data, if certain statutory conditions for restriction are met.</li>
