  ...
  <div>
    ...
    <v-container style="display: flex; margin-top: 110px; margin-bottom: 113px;">
        <div>
            ...
            <div class="mt-3">
                <span style="line-height: 28px;">We collect information that relates to you (“Personal Data”) in connection with your use of the Website, our Services. or otherwise in the context of our relationship with you. The types of Personal Data that we may obtain from you may include:</span>
            </div>
            ...
            <v-table class="mt-9" :class="isDark ? 'wallet-border':'wallet-border-light'" style="background: inherit;">
                ...
                <tbody>
                    ...
                    <tr v-for="item in policyQuestions" :key="item.name" style="height: 80px;">
            ...
            <v-table class="mt-9" :class="isDark ? 'wallet-border':'wallet-border-light'" style="background: inherit;">
                <thead :class="isDark ? 'profile-cards-dark':'profile-cards-light'">
                <tr>
                    <th class="text-left" style="height: 70px;  width: 30%;">
                    <span style="font-size: 18px; font-weight: 700;">Who we are</span>
                    </th>
                    <th class="text-left" style="height: 70px;  width: 100%;"></th>
                </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr style="height: 80px">
                        <td style="border-right: 1px solid rgba(142, 155, 174, 0.5); width: fit-content;"> 
                            <span style="font-weight: 700; font-size: 16px;" :class="isDark ? 'card-title':'card-title-light'">Who is providing this notice?</span>        
                        </td>
            ...
            <v-table class="mt-9" :class="isDark ? 'wallet-border':'wallet-border-light'" style="background: inherit;">
                ...
                <tr>
                    <th class="text-left" style="height: 70px;  width: 30%;">
                    <span style="font-size: 18px; font-weight: 700">What we do</span>
                    </th>
                    <th class="text-left" style="height: 70px;  width: 100%;"></th>
                </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr v-for="item in AboutDemo" :key="item.name" style="height: 80px">
                        ...
                        <td style="border-right: 1px solid rgba(142, 155, 174, 0.5); width: 20px;">
                            <span style="font-size: 16px;"> {{ item.answer }} </span>
                        </td>
            ...
            <v-table class="mt-9" :class="isDark ? 'wallet-border':'wallet-border-light'" style="background: inherit;">
                ...
                <tr>
                    <th class="text-left" style="height: 70px;  width: 30%;">
                    <span style="font-size: 18px; font-weight: 700;">Definitions</span>
                    </th>
                    <th class="text-left" style="height: 70px;  width: 100%;"></th>
                </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr v-for="item in definitions" :key="item.name" style="height: 80px">
                        <td style="border-right: 1px solid rgba(142, 155, 174, 0.5); width: fit-content;"> 
                            <span style="font-weight: 700; font-size: 16px;" :class="isDark ? 'card-title':'card-title-light'">{{ item.questionBold }}</span>        
                        </td>
                        ...
                        <td class="py-3" style="border-right: 1px solid rgba(142, 155, 174, 0.5); width: 20px; align-items: center;">
                            <span style="font-size: 16px;"> {{ item.answer }} </span>
                            <ul class="list-bullets-styled py-3">
                                <li> {{ item.caption }} </li>
                            </ul>
                        </td>
            ...
            <v-table class="mt-9" :class="isDark ? 'wallet-border':'wallet-border-light'" style="background: inherit;">
                <thead :class="isDark ? 'profile-cards-dark':'profile-cards-light'">
                    <tr>
                        <th class="text-left" style="height: 70px;  width: 30%;">
                        <span style="font-size: 18px; font-weight: 700;">Other important information</span>
                        </th>
                        <th class="text-left" style="height: 70px;  width: 100%;"></th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <v-container>
                    <tr style="display: flex; flex-direction: column;  width: 100%; height: 100%;">  
                        <td class="py-3" style="align-items: center; width: max-content;">
                            <span style="font-size: 16px;"> We may transfer personal information to other countries, for example, for customer service or to process transactions. </span>
                        </td>
...
const  AboutDemo = ([
          ...
          {
            questionBold: 'Why can’t I limit all sharing?',
            answer: 'Yes',
...
const  definitions = ([
          ...
          {
            questionBold: 'Nonaffiliates',
            answer: 'Companies not related by common ownership or control. They can be financial and nonfinancial companies.',
            caption:'Nonaffiliates with which we share personal information include service providers that perform services or functions on our behalf.',
          },
          {
            questionBold: 'Joint marketing',
            answer: 'A formal agreement between nonaffiliated financial companies that together market financial products or services to you.',
            caption:'Our joint marketing partners include financial companies.',
          },
