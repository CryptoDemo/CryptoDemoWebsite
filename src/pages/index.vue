      ...
      <div>
        ...
        <v-container class=" position-relative" >
            ...
            <v-row no-gutters>
              <v-col>
                <div class="ma-2 pa-2">
                  <v-img src="/svg/Frame-2.svg" v-if="theme.global.current.value.dark" ></v-img>
                  <v-img src="/svg/Frame02.svg" v-else></v-img>
                </div>
              </v-col>
                ...
                <div class="ma-2 pa-2">
                   <div :class="isDark ? 'barcode-section':'barcode-section-light'">
                      <div class="rectangle " style="padding-top: 28px;">
                          <img src="/img/Group(1).png"  style="display: flex; justify-self: center; margin: auto; width: 93%;" v-if="theme.global.current.value.dark"/>
