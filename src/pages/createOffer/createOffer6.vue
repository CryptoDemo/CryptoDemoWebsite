                ...
                <div>
                  ...
                  <div>
                    <v-row class="position-relative">
                      ...
                      <div style="background: #161D26;width: 1px; height: 735px; position: absolute; left: 0; right: 130px; display: flex; justify-self: center; margin-top: 30px;"></div>
                          <v-col cols="">
                              ...
                              <div class="d-flex" style="margin-top: 212px;">

                                <div style="display: flex;">
                                  <span class="me-13" style="color:#F8FAFC; font-family: Manrope; font-size: 16px; font-style: normal; font-weight: 700; line-height: 150%; display: flex; align-items: center;">Fixed Price rate</span>

                                </div>

                              </div>

                              <div class="d-flex" style="margin-top: 218px;">
                          ...
                          <v-col cols="7" style="margin-top: 45px;">
                            ...
                            <div style="margin-top: 8px; margin-bottom: 16px; position: relative;">
                              ...
                              <v-menu>
                                  ...
                                  <v-list style="width: 60%; border-radius: 24px;  border: 1px solid #303A46; background: #12181F;">
                                    <v-list-item>
                                      <v-row dense >
                                          <v-col v-for="(item, index) in Currency1" class="" sm="12" :key="index" >
                                        
                                            <v-list-item-title @click="currencyType1=item"> 
                                              <div style="display: flex; justify-content: center;">
                                                <span class="currency-list my-2">{{ item }}</span>
                            ...
                            <span class="select2 d-flex mb-2 mt-4">With the fixed price market rate, your offer will list at?  <span style="font-weight: 400;"> (NGN)</span></span>
                              ...
                              <span class="select1i d-flex mb-2 mt-4">Bitcoin Market Price: ₦61,160,488.67 <br>Save ₦3,058,024.43 per Bitcoin at your selected margin. With a minimum trade of ₦14,200.00, get ₦14,910.00 worth of Bitcoin in return.</span>
                              ...
                              <div style="background: #303A46; height: 1px; margin-left: 28px; margin-top: 30px; margin-bottom: 26px;"></div>
                                ...
                                <span class="select1i d-flex mb-2 mt-4">Bitcoin Market Price: ₦61,160,488.67 
                                    <br>Save ₦3,058,024.43 per Bitcoin at your selected margin. With a minimum trade of ₦14,200.00, get ₦14,910.00 worth of Bitcoin in return.
                                </span>
                          </v-col>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <v-btn class="next-step" :disabled="loading" :loading="loading" @click.prevent="navigateTo('/createOffer/createOffer7')" >Next step</v-btn>
