  ...
  <v-app>
    <NuxtLayout>
      <NuxtPage />
        ...
        <div id="my_custom_link" @click.prevent="activate_chat();"  class="flex-lg-and-up " style="display: flex; align-items: center; flex-direction: column; cursor: pointer; position: fixed; bottom: 50px; right: 10px;">
