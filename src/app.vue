<template>
  <v-app>
    ...
    <NuxtLayout>
      ...
      <Notivue v-slot="item">
        <Notification :item="item" :icons="outlinedIcons" :theme="pastelTheme" />
        <NotificationProgress :item="item" />
      </Notivue>

      <div id="my_custom_link" @click.prevent="activate_chat();" class="flex-lg-and-up hidden-sm-and-down"
        style="display: flex; align-items: center; flex-direction: column; cursor: pointer; position: fixed; bottom: 50px; right: 10px;">
        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-wechat"
          viewBox="0 0 16 16" id="my_custom_link">
          <defs>
