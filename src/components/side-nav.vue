  ...
  <div class="sd-nav1" :class="isDark ? 'profile-cards-dark':'profile-cards-light'">
   ...
   <div class="adv" :class="isDark ? 'profile-cards-dark':'profile-cards-light'" style="margin-top: 32px;">
     <div style="display: flex; justify-content: space-between;">
       ...
       <div>
         <span :class="isDark ? 'text-dark':'text-light'" style="font-family: Manrope; font-size: 16px; font-style: normal; font-weight: 800!important; line-height: 28px;">Install our mobile app to <br> receive push <br>notifications on your <br> device.</span>
       </div>
     </div>
