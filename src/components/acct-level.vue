            ...
            <div class="d-flex" style="padding: 35px"> 
               <img src="/svg/Dashboard.svg"  class="me-10" alt="dashboard-icon">
                  <div style="display: grid;">
                    <div class="d-flex">
                      <span class="acct-level1 me-2" :class="isDark ? 'text-dark':'text-light'">Account Level 1</span>
        ...
        <v-list style="border-radius: 24px; border: 1px solid #303A46; background: #12181F; width: 231px; padding: 22px; position: relative; margin-left: 170px;">
          ...
          <div style="display: flex; flex-direction: column;">
            ...
            <div style="display:flex;flex-direction: column; margin-top: 7px; margin-bottom: 29px;">
              ...
              <div>
                <span class="menu-text mt-4">Increase trade and send out limits to 10, 000 USD</span>
                <span class="menu-text my-4">Convert one crypto into another</span>
                <span class="menu-text">Trade and send any crypto</span>
              </div>
            </div>
