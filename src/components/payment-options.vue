        ...
        <template v-slot:default="{ isActive }">
          <v-card class="dialog" :class="isDark ? 'dialog':'dialog-light'">
            ...
            <div @click.stop style="margin-top: 7px; margin-bottom: 15px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" class="search-icon" style="position: absolute; top: 102px; margin-left: 19px;">
