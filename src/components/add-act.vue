          ...
          <v-card-title>
            <div class="d-flex" style="align-items: center;margin-bottom: 52px">
               <span class="me-5" style="color: #2873FF; font-family: Poppins; font-size: 16px; font-style: normal; font-weight: 600; line-height: normal;">Add account</span>
                 <img src="/flags/ad.svg" width="30" style="border-radius: 10px">
            </div>
            <div class="d-flex">
                <div>
                ...
                <div style="color: #969696; font-family: Poppins; font-size: 14px; font-style: normal; font-weight: 600; line-height: normal;">
                  ...
                  <input type="text" class="mt-1" placeholder="Okoli Bernard Chinedu" style="height: 47px; padding: 17px; width: 380px; border-radius: 16px; font-family: poppins; outline: none; background: #161D26;" />
                </div>
            </div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: self-end; margin-top: 21px;">
                  ...
                  <div >
                    <h6  @click="isHidden = !isHidden" style="color: #5892FF; font-size: 12px; cursor: pointer"> International trade details</h6>
