              ...
              <v-row class="d-flex px-3">
                <div>
                    <div class="d-flex">
                      ...
                      <span class="icon-text" style="color: #64748B; font-family: SF Pro Display; font-size: 16px;">Betacrypto Web App now available for download</span>
                    </div>
                  </div>
                      <v-col>
