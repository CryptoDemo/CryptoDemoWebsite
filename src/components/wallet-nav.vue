  ...
  <div class="">
    ...
    <div class="wallet-nav flex-lg-and-up hidden-md-and-down">
      <div class="d-flex" style="align-items: baseline; justify-content: space-between; margin-top: -2px; ">
        <span class="sm-num" :class="isDark ? 'country-name' : 'country-name-light'"
          style="font-size: 16px; font-style: normal;font-weight: 600; color: white !important;">Balance</span>
        <BlockChainNetwork />
      </div>
      ...
      <div style="margin-top: 25px; position: relative; display: flex; align-items: center;">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between;" v-if="isCamouflageEmpty">
          <span class="lg-num" v-if="isBalanceVisible"> {{
            `${pinia.state.Selectedcurrency_code}${formatBalance(pinia.state.SummedBalance)}` }} </span>
        ...
        <div style="display: flex; flex-direction: column;" v-else>
          <span class="lg-num">{{ camoflageCurrencyIcon }}{{
            formatBalance(pinia.state.user.camouflage.max_spend_balance) }}</span>
        </div>
