<template>
    <div> 
                ...
                <div v-if="transaction?.details?.crypto?.transfer">
                    ...
                    <div class="py-6 mb-5" style="display: flex; justify-content:space-between;line-height: 260%" :class="isDark ? 'txn-cards-dark' : 'txn-cards-light'">
                        ...
                        <div style="text-align: right;">
                          ...
                          <p style="font-size: 14px;">{{transaction?.details?.crypto?.transfer?.fees.find((p) => p.recipient_type === "TOTAL" )?.amount || 0}}</p>
      ...
      <div v-if="!displayedTransactions.length" class="no-transactions" style="height: 400px; display: flex; justify-content: center;">
