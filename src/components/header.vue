        ...
        <div class="header-nav-div" style="display: flex;margin-inline-start: auto;">
          ...
          <v-menu transition="slide-y-transition">
            <template v-slot:activator="{ props }">
              <v-btn @click.prevent="emit('country',country)" class="me-4 mt-7 mb-9 dropdown-btn1i" :class="isDark ? 'dropdown-btn1i':'dropdown-btn1i-light'" v-bind="props" style="display: flex; align-self: flex-start; border-radius: 16px; box-shadow: none; height: 50px; margin-top: px;">
          ...
          <div class="profile-div" v-if="icon2" style="display: flex; flex-direction: column; margin-top: 25px;">
            <Profile-nav  class="profile-nav me-8"/>
            <span class="nav-icon-text mb-3 flex-lg-and-up hidden-sm-and-down" :class="isDark ? 'text-dark':'text-light'" style="margin-left: 7px; margin-bottom: 6px;">Profile</span>    
          </div>
