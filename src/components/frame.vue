            ...
            <v-col cols="12" md="6" sm="6">
              <div class="first-col" style="margin-inline-end: 16px;">
                <div class="position-relative" :class="isDark ? 'frame1':'frame1-light'">
                      ...
                      <v-btn @click.prevent="navigateTo('#')" style="border-radius: 100px; letter-spacing: 0px; text-transform: capitalize; box-shadow: none; display: flex; margin-top: 30px; margin-bottom: 16px; background: rgba(40, 115, 255, 0.10); padding: 8px 10px; align-items: center; width: 73px; height: 36px;">
